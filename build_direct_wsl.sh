...
echo -e "${YELLOW}Building Swarmonomicon directly in WSL and deploying to EC2...${NC}"
...
# SSH to the Windows machine, build in WSL using existing code, and transfer to EC2
echo -e "${YELLOW}Building project on WSL and transferring to EC2...${NC}"
ssh salad << 'EOF'
    # Enter WSL
    wsl -d Ubuntu << 'WSLEOF'
        cd /mnt/c/Users/Dan/lab/madness_interactive/projects/common/Swarmonomicon
